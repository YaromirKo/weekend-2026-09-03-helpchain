      ...
      <div class="hc-container py-4 sm:py-0">
        <div class="flex min-h-14 items-center justify-between gap-4 sm:min-h-20">
          ...
          <nav class="hidden items-center gap-10 md:flex" aria-label="Main navigation">
            ...
            <a href="#people-need-help" class="hc-nav-link">Help Someone</a>
          </nav>
        ...
        <nav class="mt-4 grid grid-cols-2 gap-2 border-t border-hc-line pt-3 md:hidden" aria-label="Mobile navigation">
          ...
          <a href="#people-need-help" class="hc-nav-link rounded-full border border-hc-line bg-hc-paper-soft px-3 py-2 text-center">Help Someone</a>
        </nav>
      </div>
    </header>
          ...
          <div class="relative z-10 max-w-3xl">
            ...
            <div id="ask" class="mt-10 max-w-2xl">
              ...
              <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="#ask" class="hc-button hc-button-secondary min-h-11 rounded-[8px] px-4">
                  Ask for Help
                </a>
              </div>
            </div>
            ...
            <Transition name="hc-discovery" mode="out-in">
              ...
              >
                <div class="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <a href="#ask" class="hc-button hc-button-primary min-h-12 rounded-[8px] px-5">
                    Ask for help
                  </a>
                </div>
                ...
                <div class="flex flex-1 flex-col p-5">
                  ...
                  <div class="mt-auto pt-6">
                    <div class="border-t border-hc-line pt-4">
                      ...
                      <a href="#help-someone" class="hc-button hc-button-secondary mt-4 min-h-11 w-full rounded-[8px] px-4 group-hover:border-hc-emerald group-hover:text-hc-emerald">
                        I can help
                      </a>
                    </div>
                  </div>
